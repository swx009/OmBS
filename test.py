...
def getParameters():
    ...
    # general settings
    parser.add_argument('-v', '--version', type=str, default='colab_new',
    ...
    parser.add_argument('-s', '--checkpoint_epoch', type=int, default=50,
    ...
    parser.add_argument('--test_dataset_name', type=str, default='endoscopy',
                choices=['DIV2K', 'B100', 'Urban100', 'Set5', 'Set14', 'test1',"Manga109",'endoscopy'])
